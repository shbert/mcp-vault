...
| Version              | Approach                                                                                                    |
| -------------------- | ----------------------------------------------------------------------------------------------------------- |
| **v0.4.13** (current) | Keys on S3 encrypted AES-256-GCM+AAD, memory-only at runtime — 60 findings audited (28 fixed, 13 residual documented) |
...
│   ├── TECHNICAL.md          # Technical documentation (v0.4.13)
...
**License**: Apache 2.0 | **Author**: Cloud Temple | **Version**: 0.4.13
