...
| Version              | Approche                                                                                                            |
| -------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **v0.6.8** (actuel)  | Clés sur S3 chiffrées AES-256-GCM+AAD, mémoire seule au runtime — hardening C18 : singleton JWT + binding complet tenant_id/aud |
...
| ---------------------- | ------ | ---------------------------------------------------------------------------------- |
| Système                | 7      | health, about, services, tools_count (36)                                          |
...
├── VERSION                   # 0.6.8
├── DESIGN/mcp-vault/
│   ├── ARCHITECTURE.md       # Spécification détaillée (v0.6.8)
│   ├── TECHNICAL.md          # Documentation technique (v0.6.8)
...
│   ├── server.py             # FastMCP + 36 outils MCP + lifecycle + audit
...
**Licence** : Apache 2.0 | **Auteur** : Cloud Temple | **Version** : 0.6.8
