...
| Version              | Approche                                                                                                            |
| -------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **v0.4.10** (actuel)  | Clés sur S3 chiffrées AES-256-GCM+AAD, mémoire seule au runtime — 60 findings audités (28 corrigés, 13 résiduels documentés) |
...
│   ├── TECHNICAL.md          # Documentation technique (v0.4.10)
...
**Licence** : Apache 2.0 | **Auteur** : Cloud Temple | **Version** : 0.4.10
